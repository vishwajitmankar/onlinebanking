...
<div class="well">
<strong>
<p class="text-center">General Information About Admin Actions</p>
</strong>
...
<div class="span2">
    <a href="empchangepw.jsp" class="btn btn-primary">
        <i class="icon-edit icon-white"></i>
        <span><strong>Employee Change pw</strong></span>       
    </a> 	
</div>
<div class="span2">
    <a href="userchangepw.jsp" class="btn btn-primary">
    	<i class="icon-edit icon-white"></i>
	    <span><strong>Client Change pw</strong></span>        	
    </a>
</div>
<div class="span2">
    <a href="changepw.jsp" class="btn btn-primary">
    	<i class="icon-edit icon-white"></i>
	    <span><strong>Change Admin Password</strong></span>        	
    </a>
</div>
